...
proximal_theta =  raw_data.VarName8;
proximal_phi =  raw_data.VarName9;

plot_var(medial_theta,100,"Medial Theta");
plot_var(medial_phi,100,"Medial Phi");
plot_var(proximal_theta,100,"Proximal Theta");
plot_var(proximal_phi,100,"Proximal Phi");
